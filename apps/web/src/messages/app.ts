...
export const messages = defineMessages('safu', {
  ...
  shareCopied: 'Copied',
  shareSend: 'Send',
  shareInvite: 'I shared something with you on Safu — open it here:',
  ...
  identityDesc:
    'The identity your other devices link to — and what an always-on node hosts your shares for.',
  signingIdLabel: 'Signing ID',
  transportIdLabel: 'Transport address',
  ...
  removeHint: 'Unlink a device you no longer use. It loses access and can’t be re-added.',
  removePrompt: 'Remove this device? It loses access and can’t be re-added.',
...
export const messagesEli5 = defineMessages('safu.eli5', {
  ...
  shareCopied: 'Copied',
  shareSend: 'Send it',
  shareInvite: 'I sent you something on Safu — open it here:',
  ...
  identityTitle: 'This gadget',
  identityDesc: 'The name tag your other gadgets use to find this one and trust it.',
  signingIdLabel: 'Signing ID',
  transportIdLabel: 'Network address',
  relayLabel: 'Home relay',
  ...
  linkedLabel: 'Added',
  colDeviceName: 'Gadget',
  colStatus: 'Status',
  removeDevice: 'Remove this gadget',
  removeHint: 'Unhook a gadget you don’t use anymore. It can’t get in, and you can’t add it back.',
  removePrompt: 'Remove this gadget? It can’t get in anymore, and you can’t add it back.',
...
export const messagesMachine = defineMessages('safu.machine', {
  ...
  watchHint:
    'point sharu at a folder on this device. new|changed files inside → auto encrypt + back up. no drag. desktop only.',
  backupTitle: 'wallet backup',
  ...
  identityTitle: 'this device',
  identityDesc: 'local signing identity + transport address; what peers link to.',
  signingIdLabel: 'signing id',
  transportIdLabel: 'transport addr',
  relayLabel: 'home relay',
  ...
  colStatus: 'status',
  removeDevice: 'remove device',
  removeHint: 'unlink device. write-revoked (permanent tombstone), re-auth blocked.',
  removePrompt: 'remove device? write-revoked permanently, cannot re-add.',
  confirmRemove: 'remove',
  cancelRemove: 'cancel',
  watchHeading: 'watched folders',
