...
// Rust `print_usage()` text and `Args` parser in crates/sharu/src/main.rs,
...
export function renderModule(spec: CliSpec): string {
  return `// GENERATED by \`pnpm gen:cli-docs\` from crates/sharu — do not edit by hand.
